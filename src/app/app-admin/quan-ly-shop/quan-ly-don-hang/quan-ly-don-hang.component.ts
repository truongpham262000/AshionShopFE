...
import { QuanLyDonHangCreateComponent } from './quan-ly-don-hang-create/quan-ly-don-hang-create.component';
import { AshionShop, PageModel, ShippingCardModelListPageModelView } from '../../../@core/data/ashion-shop.service';
import { MatDialog } from '@angular/material/dialog';
import { CommonService } from '../../../@core/customs/common.service';

@Component({
  selector: 'ngx-quan-ly-don-hang',
...
export class QuanLyDonHangComponent implements OnInit {
  ...
  target: ShippingCardModelListPageModelView = new ShippingCardModelListPageModelView();
  ...
  loadData() {
    this.api.shippingCardPagingData(this.pageModel).subscribe((res) => {
  ...
  openCreateDialog() {
    this.dialog.open(QuanLyDonHangCreateComponent,
  ...
  openDeleteDialog(id: string, title: string) {
    this.dialog
        ...
        .subscribe((dialog) => {
          if (dialog) {
            this.api.shippingCardDelete(id).subscribe((res) => {
              if (res.code === SUCCESS_RESPONSE) {
