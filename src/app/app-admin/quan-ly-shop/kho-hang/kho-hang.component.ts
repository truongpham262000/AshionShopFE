...
import { KhoHangCreateComponent } from './kho-hang-create/kho-hang-create.component';
import { AshionShop, KhoSpModelListPageModelView, PageModel } from '../../../@core/data/ashion-shop.service';
import { CommonService } from '../../../@core/customs/common.service';
import { MatDialog } from '@angular/material/dialog';

@Component({
  selector: 'ngx-kho-hang',
...
export class KhoHangComponent implements OnInit {
  ...
  target: KhoSpModelListPageModelView = new KhoSpModelListPageModelView();
  ...
  loadData() {
    this.api.khoSpPagingData(this.pageModel).subscribe((res) => {
  ...
  openCreateDialog() {
    this.dialog.open(KhoHangCreateComponent,
  ...
  openDeleteDialog(id: string, title: string) {
    this.dialog
        ...
        .subscribe((dialog) => {
          if (dialog) {
            this.api.khoSpDelete(id).subscribe((res) => {
              if (res.code === SUCCESS_RESPONSE) {
